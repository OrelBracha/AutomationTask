...
public class YnetTesting
{
	public static void main(String[] args) throws InterruptedException
	{
		...
		*/
		...
		Launch_Browser page= new Launch_Browser(driver,website);// Open page.
		String xPathOfElement = "//*[@id=\"tsf\"]/div[2]/div[1]/div[1]/div/div[2]/input";
		String stringToFill = "Ynetnews";
		...
		page.VerifyElementIsExist(elementName, xPathOfElement,ObjectType.Button);
		// Open "send to friend".
		page.ScrollPage();
        ...
        page.VerifyElementIsExist(elementName, xPathOfElement, ObjectType.Checkbox);
	}
